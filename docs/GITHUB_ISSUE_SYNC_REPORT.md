...
- Registry-backed VIS issues: 27
- Latest new VIS issues created: VIS-022 through VIS-027 / issues #29-#34
...
- VIS-027 / issue #34 marked `status:done` and closed as completed
...
| VIS-027 | [#34 Add selected-asset dashboard command shelf](https://github.com/frankxai/visual-intelligence/issues/34) | M1 Daily Cockpit |
